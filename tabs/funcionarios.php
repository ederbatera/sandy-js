  ...
  <div class="row justify-content-between">
    <div class="col-2">
      <div class="input-group input-group-sm">
        ...
        <input type="password" class="form-control form-control-sm" id="rfidCardInput" name="rfidCardInput"
          aria-label="Sizing example input" aria-describedby="inputGroup-rfid-sm">
        <button class="btn btn-sm btn-outline-dark" type="button" id="findRfidCard" onclick="getRFID()"><i
    ...
    <div class="col-4">
      <div class="input-group input-group-sm">
        ...
        <input type="text" class="form-control" onblur="this.value = this.value.toUpperCase();"
          id="search-input-funcionarios" style="text-transform: uppercase;">
      </div>
    </div>
    <div class="col-auto ml-auto">
      <button class="btn btn-sm btn-outline-dark" type="button" data-bs-toggle="modal"
        data-bs-target="#modalAddFuncionario"><i class="fa-solid fa-person-circle-plus fa-xl"></i></button>
      <button class="btn btn-sm btn-outline-dark ml-2" type="button" id="btn-atualizaFuncionarios"
        onclick="fetchData()"><i class="fa-solid fa-rotate fa-xl"></i></button>
    </div>
  </div>
  <div class="row mt-4 text-center justify-content-center">
    ...
    <div class="col-12 overflow-auto" style="height: 60vh">
      <table class="table table-success table-sm table-borderless table-responsive table-hover text-start"
        ...
        <tbody class="table-persona" id="tbody-list-funcionarios">
          <!-- Append JS -->
        </tbody>
      </table>
    </div>
...
<div class="modal fade text-dark" id="modalViewFuncionario" data-bs-backdrop="static" data-bs-keyboard="false"
  tabindex="-1" aria-labelledby="modalViewFuncionarioLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content border border-primary" style="background-color: #00FFFF">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="modalViewFuncionarioLabel">
          <div id="modalTitleNameFuncionario"></div>
        </h1>
          ...
          <div class="col-3">
            <div class="border border-primary p-1 rounded">
              <form id="form-change-img" enctype="multipart/form-data" autocomplete="off" method="post" action="">
                <span id="formFuncionario-imgPerfil"><img src="../img/perfil/null.jpg"
                    class="img-thumbnail rounded float-end mb-1" alt="..."></span>
                <div class="row justify-content-between align-items-center">
                  <div class="col-auto">
                    <!-- <div id="res-post-img" class="fs-5"></div> -->
                  </div>
                  <div class="col-auto">
                    <label for="formFuncionario-img-change" class="btn btn-sm btn-primary m-1"><i
                        class="fa-solid fa-upload"></i></label>
                    <input type="file" class="form-control" id="formFuncionario-img-change"
                      name="formFuncionario-img-change" onchange="sendImgPerfil()">
                    <input type="hidden" id="formFuncionario-img-matricula" name="formFuncionario-img-matricula"
                      value="">
                    <button type="button" class="btn btn-sm btn-danger m-1" onclick="deleteImgPerfil()"><i
...
<div class="modal fade text-dark" id="modalAddFuncionario" data-bs-backdrop="static" data-bs-keyboard="false"
  tabindex="-1" aria-labelledby="modalAddFuncionarioLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content border border-primary" style="background-color: #00FFFF">
      <div class="modal-header">
        ...
        <form class="form form-sm row g-3" id="formAddFuncionario" autocomplete="off" action="/">
          ...
          <div class="row mb-3">
            ...
            <div class="col-2">
              ...
              <input type="tel" class="form-control form-control-sm" name="celular" data-mask="(00) 00000-0000"
                onkeyup="handlePhone(event)" autocomplete="off" maxlength="15">
            </div>
