...
const usersAllElem = document.getElementById('usersAll');
...
function updateCounts() {
  ...
  usersAllElem.textContent = __FUNCIONARIOS.length;
  //$("#usersWithRights").html(usersWithRights.length);
  usersWithRightsElem.textContent = usersWithRights.length;
}
